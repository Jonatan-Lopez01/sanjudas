...
class MesaController {
    insertar_mesa(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res.json(resp);
            //verificar que el numero de mesa no este repetido.
            //si esta repetido entonces que no inserte
            // sino esta repetido entonces que si inserte
        });
    }
    ...
    buscar_mesa_id(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT * FROM mesa WHERE mesero_id = ?', [id]);
    ...
    mostrar_todas_mesas(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const respuesta = yield database_1.default.query('SELECT * FROM mesa');
            res.json(respuesta);
        });
    }
}
